    ...
    return(
        <section className="pt-10">
            ...
            <div className="flex flex-col px-5 sm:px-10 gap-5">
                ...
                <div className="w-full flex justify-center items-start gap-10 sm:flex-row flex-col-reverse relative py-10 sm:py-0">
                    <div className="max-w-[450px] w-full xl:py-25 lg:py-0">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute z-[-1] bottom-[94px] right-[-40px] sm:block hidden xl:bottom-[100px] tv-hidden">
                            <Image src={'/lines-1.png'} alt="desktop" width={400} height={700} loading="lazy" className="xl:w-[700px]"></Image>
                        </div>
                    </div>

                    <div className="absolute z-[-1] bottom-[-130px] sm:block hidden xl:bottom-[-280px] xl:left-[200px] tv-hidden">
                        <Image src={'/lines-2.png'} alt="desktop" width={600} height={700} loading="lazy" className="xl:w-[950px]"></Image>
                    </div>
                </div>

                <div className="w-full flex justify-center items-start gap-10 sm:flex-row flex-col relative py-10 sm:py-0">
                    <div>
                    ...
                    <div className="absolute z-[-1] bottom-[-140px] sm:block hidden xl:bottom-[-240px] xl:left-[500px] tv-hidden">
                ...
                <div className="w-full flex justify-center items-start gap-10 sm:flex-row flex-col-reverse relative py-10 sm:py-0">
                    ...
                    <div className="absolute z-[-1] bottom-[-140px] sm:block hidden xl:bottom-[-260px] xl:left-[200px] tv-hidden">
                        <Image src={'/lines-2.png'} alt="desktop" width={600} height={700} loading="lazy" className="xl:w-[950px]"></Image>
                    </div>
                </div>
                ...
                <div className="w-full flex justify-center items-center gap-10 sm:flex-row flex-col relative py-10 sm:py-0">
                    ...
                    <div className="absolute z-[-1] bottom-[-290px] sm:block hidden xl:bottom-[-335px] xl:left-[200px] tv-hidden">
                        <Image src={'/lines-4.png'} alt="desktop" width={600} height={700} loading="lazy" className="xl:w-[950px]"></Image>
                    </div>
                </div>

                <div className="w-full flex justify-center items-end gap-10 sm:flex-row flex-col-reverse pt-10 sm:py-0">
                    <div className="max-w-[450px] w-full xl:py-25 lg:py-0">
