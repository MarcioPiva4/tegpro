...
export default function SectionBanner(){
    return(
        <section className="first-section relative">
            <div className="bg-[url('/background.avif')] bg-cover bg-center text-white h-screen w-full flex justify-start pt-[125px] lg:pt-0 lg:justify-center items-center flex-col p-3 lg:p-5 relative">
                ...
                <div className="absolute bottom-[150px] lg:bottom-[50px] bg-black/50 py-2 px-5 rounded-xl mx-5 z-[1]">
